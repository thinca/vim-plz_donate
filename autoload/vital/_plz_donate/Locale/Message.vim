...
execute join(['function! vital#_plz_donate#Locale#Message#import() abort', printf("return map({'get_lang': '', 'new': ''}, \"vital#_plz_donate#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
